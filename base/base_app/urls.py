...
# Project Libraries
# from user.views import Client_dashboard, test_template, test_template_form,testing
from user.views import Client_dashboard, test_template, test_template_form
...
urlpatterns += [
    ...
    # Added for the purpose of testing backend
    # path("testing/", view=testing, name="testing"),
]
